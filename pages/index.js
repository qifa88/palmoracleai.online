...
export default function Home() {
  ...
  return (
    <div className="relative bg-black min-h-screen text-gold flex flex-col items-center justify-center px-4 overflow-hidden">
      ...
      {/* 顶部标题区域 - 对应红框位置 */}
      <div className="relative z-10 flex flex-col items-center mt-8 w-full">
        <motion.h1
        ...
        <p className="upload-instruction mt-0">Upload a photo of your palm for AI-powered fortune reading</p>
      </div>
